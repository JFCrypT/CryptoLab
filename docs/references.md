...
Normative standards and published vector sources are added with each implemented modern
primitive. Local vector manifests record the source document, section or test identifier,
